...
nmcli con mod XfinityMobile 802-1x.eap ttls 802-1x.identity "<Base64 String From MAC Config>" 802-1x.password "<Base64 String from MAC Config>" 802-1x.anonymous-identity "xanonymous-ttls@xfinity.com" 802-1x.phase2-domain-suffix-match "*.aaa.wifi.comcast.com;*.aaa.wifi.xfinity.com" wifi-sec.key-mgmt wpa-eap 802-1x.phase1-auth-flags 6 802-1x.phase2-auth pap
